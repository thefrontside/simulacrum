...
import { headingMd, textBlue, textGradientPinkViolet, textGradientSkybluePink, textGradientPurpleViolet, textSm, textGradientGreenSkyblue } from "../../css/typography.css";
...
const simulacrumNav = style({
  backgroundImage: `linear-gradient(45deg, ${vars.colors.blue} -5%, ${vars.colors.violet}, ${vars.colors.green} 105%)`,
});
...
export const navBar = styleVariants({
  ...
  'Simulacrum': [navWrap, simulacrumNav],
  default: [navWrap]
});
...
export const projectCurrent = styleVariants({
  ...
  'Simulacrum': [projectTitle, textGradientGreenSkyblue],
