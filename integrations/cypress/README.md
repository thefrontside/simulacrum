...
with [Auth0](https://auth0.com)! @simulacrum/auth0-cypress will simulate an auth0 server, running on `localhost`, so you
...
- [auth0-vue](https://www.github.com/auth0/auth0-vue)
...
Under the hood, [@simulacrum/auth0-cypress](https://github.com/thefrontside/simulacrum/tree/v0/integrations/cypress)
uses another package
called [@simulacrum/auth0-simulator](https://github.com/thefrontside/simulacrum/tree/v0/packages/auth0) which will first
